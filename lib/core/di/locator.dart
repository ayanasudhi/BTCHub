...
void setupLocator() {
  ...
  locator.registerFactory<BTCApiClient>(
      () => BTCApiClient(requestManager: locator<IApiRequestManager>()));

  locator.registerFactory<BTCRepository>(
      () => BTCRepository(btcApiClient: locator<BTCApiClient>()));
}
